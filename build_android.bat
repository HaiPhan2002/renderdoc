...
%ANDROID_HOME%\cmake\3.22.1\bin\cmake -DBUILD_ANDROID=On -DANDROID_ABI=x86_64 -DAPK_TARGET_ID=android-28 .\CMakeLists.txt -DCMAKE_MAKE_PROGRAM=%ANDROID_HOME%\cmake\3.22.1\bin\ninja.exe --log-level=VERBOSE -GNinja
